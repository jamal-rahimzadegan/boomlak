        ...
        return (
            <View style={styles.MainView}>
                <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
                    <Header navigation={this.props.navigation} PageTitle={'ایجاد تور'}/>
                    ...
                    <TouchableOpacity style={[styles.AddBtn, {}]} onPress={() => this._Addtourism()}>
                        <Text
...
//---------------------_SelectProvince--------------------------------------------------------------------------------------
    ...
    _Addtourism() {
        ...
        if(SelectedProID,
            ...
            Connect.SendPRequest(URLS.Link() + "addtourism", {
                userId: parseInt(ID),
