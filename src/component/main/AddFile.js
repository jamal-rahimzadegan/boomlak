        ...
        return (
            <View style={styles.MainView}>
                <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
                    <Header navigation={this.props.navigation} PageTitle={'افزودن فایل'}/>
                    ...
                    <TouchableOpacity style={[styles.AddBtn, {}]} onPress={() => this._AddFile()}>
                        <Text
...
//---------------------_SelectProvince--------------------------------------------------------------------------------------
    ...
    _AddFile() {
        ...
        if (
            ...
            Connect.SendPRequest(URLS.Link() + "addfile", {
                userId: parseInt(ID),
                ...
                if (res.result) {
                    this.dropdown.alertWithType('success', '', "ملک با موفقیت اضافه شد");
