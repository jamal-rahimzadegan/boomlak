        ...
        return (
            <View style={styles.MainView}>
                <ScrollView style={{flex: 1}} showsVerticalScrollIndicator={false}>
                    <Header navigation={this.props.navigation} PageTitle={'ویرایش آگهی'}/>
                    ...
                    <TouchableOpacity style={[styles.AddBtn, {}]} onPress={() => this._UpdateAd(this.props.navigation.getParam('id'))}>
                        <Text
...
//---------------------Get Detials --------------------------------------------------------------------------------------
    _GetDetails(id) {
        ...
        Connect.SendPRequest(URLS.Link() + "advertise", {id:parseInt(id)})
            .then(resp => {
                console.log('advertise Details: ');
                console.warn(resp);
                if (resp) {
                    let res=resp.adver
                    this.setState({
    ...
    _UpdateAd(id) {
        ...
        if (SelectedProID,
            ...
            Connect.SendPRequest(URLS.Link() + "editadvertise", {
                id:parseInt(id),
                userId: parseInt(ID),
                ...
                console.warn(res);
                if (res.result) {
                    this.dropdown.alertWithType('success', '', "تبلیغ با موفقیت ویرایش شد");
